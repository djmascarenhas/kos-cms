...
export default async function ProposalPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main className="min-h-screen bg-[#f2f7fb] text-[#40566a]">
    ...
    <section className="mx-auto max-w-7xl px-6 py-12">
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-2"><Analysis title="Análise no PMS 2026–2029" status={proposal.pmsStatus} rationale={proposal.pmsRationale} reference={proposal.pmsReference} href="/pms-2026-2029" /><Analysis title="Análise na PAS 2026" status={proposal.pasStatus} rationale={proposal.pasRationale} reference={proposal.pasReference} href="/pas-2026" /></div>
    ...
    <footer className="bg-[#17375e] px-6 py-8 text-center text-sm text-[#cbdce8]">Conselho Municipal de Saúde de Chapada dos Guimarães · Acompanhamento público das propostas</footer>
  </main>;
}
